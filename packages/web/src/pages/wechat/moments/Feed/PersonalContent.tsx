          ...
          return (
            <div className="grid h-18 w-18 grid-cols-2 gap-[2px]">
              ...
              <div className="grid h-18 grid-rows-2 gap-[2px]">
                ...
                <h.img src={content.imagesInfo[2]} className="h-full w-full object-cover object-center" />
              </div>
            </div>
          );
        }
        ...
        if (content.videoInfo) {
          return (
            <div className="relative h-18 w-18">
              ...
              <div className="absolute left-1/2 top-1/2 flex h-auto w-auto origin-center -translate-x-1/2 -translate-y-1/2 scale-75 cursor-pointer items-center justify-center rounded-full border border-white">
