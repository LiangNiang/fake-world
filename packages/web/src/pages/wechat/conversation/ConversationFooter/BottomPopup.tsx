...
import { createContext, memo, PropsWithChildren, RefObject, useContext, useMemo, useRef } from 'react';
...
const BottomPopup = ({ children, show, ...rest }: PropsWithChildren<Props & Partial<CSSTransitionProps>>) => {
