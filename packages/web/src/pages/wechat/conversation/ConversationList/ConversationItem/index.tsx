...
import { EConversationRole, EConversationType, TConversationItem } from '@/state/conversationState';
...
const ConversationItem = ({ data }: Props) => {
  ...
  switch (type) {
    ...
    case EConversationType.image:
      return <Image role={role} imageInfo={data.imageInfo} upperText={upperText} senderId={senderId} />;
