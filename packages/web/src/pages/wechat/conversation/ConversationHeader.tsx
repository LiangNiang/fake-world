...
const ConversationHeader = () => {
  ...
  const [totalUnreadCount, friendProfile] = useRecoilValue(waitForAll([totalUnreadCountState, friendState(id ?? '')]));
  const navigate = useModeNavigate();

  return (
    <div className="grid grid-cols-3 border-b border-black/5 bg-[#F5F5F5] px-4 py-2">
