...
const DataSourceList = () => {
	...
	const TABLE_COLUMNS: ColumnsType<IDataSourceItem> = [
		...
		},
		{
			...
			dataIndex: "name",
			render: (name: IDataSourceItem["name"], record) =>
				(record.id === ENV_VERSION_KEY ? t("menu.dataSourceManage.defaultData") : name) ?? "-",
		},
		{
		...
		},
		{
			...
			dataIndex: "isCurrent",
			render: (isCurrent: IDataSourceItem["isCurrent"]) =>
				isCurrent ? t("base.yes") : t("base.no"),
		},
		{
	...
	return (
		<div className="flex flex-col">
			<div className="font-semibold text-lg">{t("menu.dataSourceManage.list")}</div>
			<Global
				styles={css`
          .isCurrent {
