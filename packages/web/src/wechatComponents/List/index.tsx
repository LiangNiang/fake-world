...
export const ListItem = ({
  ...
  return (
    <div
      className={twMerge('group/item relative flex items-center', (withJump || rest.onClick) && 'cursor-pointer', className)}
      {...omit(rest, 'className', 'children')}
    >
      {renderTextPrevNode()}
      <div className={twMerge('relative flex flex-1 items-center border-b border-black/5 py-3 pr-3 group-last/item:border-none', rightClassName)}>
