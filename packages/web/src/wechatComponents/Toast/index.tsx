    ...
    <Transition nodeRef={nodeRef} in={show} timeout={300} onExited={() => onExited?.()}>
      {(state) => (
        <div
          ...
          ref={nodeRef}
          className={twJoin(
            'absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center bg-wechatBG-2 text-white opacity-0 transition-opacity duration-300',
